    ...
    >
      <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
        ...
        <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
          ...
          vantagens de ser um aluno da primeira turma da imersão{" "}
          <span className="font-bold text-primary">Ato da Evolução</span>
        </p>
      </div>
      ...
      <div className="grid w-full border rounded-lg items-start gap-10 p-10 md:grid-cols-[1fr_200px]">
        <div className="grid gap-6">
          ...
          <ul className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
            ...
            <li className="flex items-center">
              <Check className="mr-2 h-4 w-4" /> Recomendações de Livros e
              Cursos
            </li>
            <li className="flex items-center">
